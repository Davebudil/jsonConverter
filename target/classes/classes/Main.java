...
//                     Create a sample database
                    ...
                    sql =   "USE [master]\n" +
                            "DROP DATABASE IF EXISTS [register2018b]; CREATE DATABASE [register2018b]\n" +
                            "ALTER DATABASE [register2018b] SET ANSI_NULL_DEFAULT OFF \n" +
                            "ALTER DATABASE [register2018b] SET ANSI_NULLS OFF \n" +
                            "ALTER DATABASE [register2018b] SET ANSI_PADDING OFF \n" +
                            "ALTER DATABASE [register2018b] SET ANSI_WARNINGS OFF \n" +
                            "ALTER DATABASE [register2018b] SET ARITHABORT OFF \n" +
                            "ALTER DATABASE [register2018b] SET AUTO_CLOSE OFF \n" +
                            "ALTER DATABASE [register2018b] SET AUTO_CREATE_STATISTICS ON \n" +
                            "ALTER DATABASE [register2018b] SET AUTO_SHRINK OFF \n" +
                            "ALTER DATABASE [register2018b] SET AUTO_UPDATE_STATISTICS ON \n" +
                            "ALTER DATABASE [register2018b] SET CURSOR_CLOSE_ON_COMMIT OFF \n" +
                            "ALTER DATABASE [register2018b] SET CURSOR_DEFAULT  GLOBAL \n" +
                            "ALTER DATABASE [register2018b] SET CONCAT_NULL_YIELDS_NULL OFF \n" +
                            "ALTER DATABASE [register2018b] SET NUMERIC_ROUNDABORT OFF \n" +
                            "ALTER DATABASE [register2018b] SET QUOTED_IDENTIFIER OFF \n" +
                            "ALTER DATABASE [register2018b] SET RECURSIVE_TRIGGERS OFF \n" +
                            "ALTER DATABASE [register2018b] SET  DISABLE_BROKER \n" +
                            "ALTER DATABASE [register2018b] SET AUTO_UPDATE_STATISTICS_ASYNC OFF \n" +
                            "ALTER DATABASE [register2018b] SET DATE_CORRELATION_OPTIMIZATION OFF \n" +
                            "ALTER DATABASE [register2018b] SET TRUSTWORTHY OFF \n" +
                            "ALTER DATABASE [register2018b] SET ALLOW_SNAPSHOT_ISOLATION OFF \n" +
                            "ALTER DATABASE [register2018b] SET PARAMETERIZATION SIMPLE \n" +
                            "ALTER DATABASE [register2018b] SET  READ_WRITE \n" +
                            "ALTER DATABASE [register2018b] SET RECOVERY FULL \n" +
                            "ALTER DATABASE [register2018b] SET  MULTI_USER \n" +
                            "ALTER DATABASE [register2018b] SET PAGE_VERIFY CHECKSUM  \n" +
                            "ALTER DATABASE [register2018b] SET DB_CHAINING OFF ";
                    ...
                    sql =   "USE [register2018b] \n" +
                            "CREATE TABLE [dbo].[reg101_appln](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[appln_id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[appln_auth] [char](2) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[appln_nr] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[appln_filing_date] [date] NOT NULL DEFAULT ('99991231'),\n" +
                            "\t[filing_lg] [char](2) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[status] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[internat_appln_id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[internat_appln_nr] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[bio_deposit] [char](1) NOT NULL DEFAULT ('N'),\n" +
                            "PRIMARY KEY CLUSTERED \n" +
                            "(\n" +
                            "\t[id] ASC\n" +
                            ")WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg102_pat_publn](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            ...
                            ")WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg103_ipc](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[ipc_text] [varchar](800) NOT NULL DEFAULT (''),\n" +
                            ...
                            ")WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg106_prior](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[change_date] [date] NOT NULL DEFAULT ('99991231'),\n" +
                            "\t[bulletin_year] [smallint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[bulletin_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[prior_seq_nr] [smallint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[prior_kind] [varchar](13) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[prior_auth] [char](2) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[prior_nr] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[prior_date] [date] NOT NULL DEFAULT ('9999-12-31')\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg107_parties](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[set_seq_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[is_latest] [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[change_date] [date] NOT NULL DEFAULT ('99991231'),\n" +
                            "\t[bulletin_year] [smallint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[bulletin_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[type] [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[wishes_to_be_published] [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[seq_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[designation] [varchar](12) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[customer_id] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[name] [nvarchar](300) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            ...
                            ")WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg108_applicant_states](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[set_seq_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[bulletin_year] [smallint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[bulletin_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            ...
                            ")WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]\n" +
                            ") ON [PRIMARY]\n" +
                            "CREATE TABLE [dbo].[reg109_designated_states](\n" +
                            "\t[id] [int] NOT NULL DEFAULT ('0'),\n" +
                            "\t[state_type] [varchar](3) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "\t[change_date] [date] NOT NULL DEFAULT ('99991231'),\n" +
                            "\t[bulletin_year] [smallint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[bulletin_nr] [tinyint] NOT NULL DEFAULT ('0'),\n" +
                            "\t[designated_states] [varchar](150) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT (''),\n" +
                            "PRIMARY KEY CLUSTERED \n" +
                            "(\n" +
                            "\t[id] ASC,\n" +
                            "\t[state_type] ASC,\n" +
...
//                    Insert Data
                    ...
                    sql =   "USE register2018b\n" +
                            "SELECT\n" +
                            "\t   appln.id 'application.application_id' \n" +
